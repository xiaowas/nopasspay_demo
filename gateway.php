<?php
    ...
    $thoroughfare = isset($_POST['type']) ? $_POST['type'] : '';
    //支付金额
    ...
    $device_key = '225067CF8A84357C76';
    //异步通知接口url->用作于接收成功支付后回调请求
    $callback_url = 'https://requestbin.leo108.com/rgtxu7rg';
    //支付成功后自动跳转url
...
<body>
<form action="http://pp.ana51.com/gateway/index/checkpoint.do " method="post" id="frmSubmit">
    ...
    <input type="hidden" name="extend" value="<?php echo $extend; ?>"/>
